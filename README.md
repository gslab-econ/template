...
#### Pre-requisites:
 ...
 Installing the some of the applications above is easiest with [Homebrew](http://brew.sh/) on Mac OS and [Linuxbrew](http://linuxbrew.sh/) as they will set up the PATH variable for you.
